      ...
      <div className="mx-auto p-8 max-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="grid gap-8 sm:grid-cols-2 sm:gap-y-10 xl:grid-cols-3">
          ...
          <div className="relative rounded-lg p-5 pt-8 bg-bg-pink-thin" style={{ borderRadius: "1rem"}}>
            ...
            <p className="text-gray-500">JavaScript・SQLを使用しています。プラットフォームはVercel・GitHubを使用しています。ソフトウェアについては、Illustrator・Blender等を使用しています。</p>
          </div>
          ...
          <div className="relative rounded-lg p-5 pt-8 bg-bg-pink-thin" style={{ borderRadius: "1rem"}}>
            ...
            <p className="text-gray-500">セキュリティリスクに対して、2つの側面から対策を行っています。当組織が実施しているセキュリティでは、お客様の個人情報は法令遵守の保護を実施しており、当組織が利用しているサービスのセキュリティでは、DDoS保護・SOC2 Type2準拠・HTTPS/TLS 1.3を使用しています。</p>
          </div>
          ...
          <div className="relative rounded-lg p-5 pt-8 bg-bg-pink-thin" style={{ borderRadius: "1rem"}}>
            ...
            <h3 className="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">イラストなど3Dモデル以外の制作依頼は受け付けていますか?</h3>
            <p className="text-gray-500">3Dモデル</p>
          </div>
          ...
          <div className="relative rounded-lg p-5 pt-8 bg-bg-pink-thin" style={{ borderRadius: "1rem"}}>
            ...
            <h3 className="mb-3 text-lg font-semibold text-indigo-500 md:text-xl">支払方法は何がありますか？</h3>
            <p className="text-gray-500">支払方法にはいくつかの選択肢がありますが、私たちの提案といたしましては、毎月定期的にお支払いをいただく形をご提供しております。具体的には、私たちの指定の銀行口座に毎月一定額をお振り込みする形となります。この支払方法により、お客様の負担を最小限に抑えつつ、安定した予算管理が可能となります。お支払いスケジュールや金額は、事前にお客様のご要望に合わせて調整させていただきます。</p>
          </div>
