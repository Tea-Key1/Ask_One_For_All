...
export default function Document() {
    return (
        <motion.div className="h-auto w-screen flex flex-col"
            initial={{
                opacity: 0,
            }}
            animate={{
                    ...
                    <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
                        ...
                        <div className="relative rounded-lg p-5 pt-8 bg-bg-pink-thin" style={{ borderRadius: "1rem" }}>
                            <div className="flex-grow">
                                ...
                                <p className="leading-relaxed text-base text-start">現代のビジネス環境において、最新技術を活用したWebサイトは大きな効果をもたらしますが、その実現には一定のコストが伴います。こうした認識のもと、当組織はお客様の成長を妨げず、かつ可能な限り負担を軽減するため、初期費用を抑えるプランを提供しています。私たちの目指すのは、高品質なウェブサイトを実現しつつ、お客様の予算に合わせた柔軟な解決策を提供することです。私たちは、初期費用を最小限に抑えながらも、妥協のない品質を保ち、お客様のビジョンと目標を達成するための最良の方法を模索しています。</p>
                            </div>
                        </div>
                    </div>
