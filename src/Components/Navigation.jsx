        ...
        <>
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
                    <a href="/" className="flex items-center py-4 px-3 hover:bg-white hover:text-red-300 hover:translate-y-[-5px] transition duration-500">
                        ...
                        <div className="hidden md:flex md:flex-row rounded-lg">
                            ...
                            <SectionButton label="はじめに" onClick={() => setSection(1)} />
                            <SectionButton label="サービス紹介" onClick={() => setSection(2)} />
                            <SectionButton label="コスト" onClick={() => setSection(3)} />
                            <SectionButton label="実績" onClick={() => setSection(4)} />
            ...
            {width <= 768 && (
                ...
                >
                    ...
                    <a onClick={() => { setSection(3); setMenuOpen(!menuOpen) }} className="block px-4 py-3">コスト</a>
                    <a onClick={() => { setSection(4); setMenuOpen(!menuOpen) }} className="block px-4 py-3">実績</a>
